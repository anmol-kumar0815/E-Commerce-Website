...
define('PAYTM_MERCHANT_KEY', 'tsETKHs@OtOtGM1f'); //Change this constant's value with Merchant key received from Paytm.
define('PAYTM_MERCHANT_MID', 'zWNxIi57030425643167'); //Change this constant's value with MID (Merchant ID) received from Paytm.
...
if (PAYTM_ENVIRONMENT == 'PROD') {
	...
	$PAYTM_MERCHANT_MID 		= "zWNxIi57030425643167";
	$PAYTM_MERCHANT_KEY 		= "tsETKHs@OtOtGM1f";
	...
	$PAYTM_CALLBACK_URL 	= "http://localhost/PaytmKit/pgResponse.php";
